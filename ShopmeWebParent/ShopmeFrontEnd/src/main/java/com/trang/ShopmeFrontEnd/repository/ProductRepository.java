package com.trang.ShopmeFrontEnd.repository;
...
//	@Query(value = "SELECT * FROM products WHERE enabled = true AND MATCH(name, short_description, full_description) AGAINST keyword = :keyword", nativeQuery = true)
